...
@else
	@section('title', 'Jobs not found')
@endif

@section('page', 'page-jobs')		
@section('content')
<!-- START @PAGE CONTENT -->
	...
	<div class="body-content animated fadeIn" style="background-color: #e9eaed;">
			<div class="panel">
					...
					<form class="form-horizontal" method="GET" style="padding-top: 8px!important;">
						<div class="form-group no-margin no-padding has-feedback">
							...
							<div class="col-md-2">
								...
								{!! Form::select('game_id', ['' => 'All'] + App\Http\Models\Front\JobModel::_getGamesList(), Request::has('game_id') ? Request::get('game_id') : '', ['class' => 'form-control', 'autocomplete' => 'off', 'onchange' => 'this.form.submit()']) !!}
								</div>
							</div>
							<div class="col-md-2">
								<div class="input-group" style="width: 100%;">
				...
				<div class="panel-body"><!-- /.panel-body -->
					@include('laravel-authentication-acl::client.jobs.single')
				</div><!-- /.panel -->
				<div class="panel-footer">
					<div class="text-center">
					{{ $links->appends(['search' => Request::get('search'), 'game_id' => Request::get('game_id'), 'sort' => Request::get('sort'), 'added' => Request::get('added'), 'price_min' => Request::get('price_min'), 'price_max' => Request::get('price_max')])->links() }}
					</div>
				</div>
			</div>
	</div><!-- /.body-content -->
