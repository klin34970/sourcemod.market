...
@if(!$scripts->isEmpty())
	@section('title', $scripts->first()->game->title)
	@section('description', $scripts->first()->game->title . ' scripts marketplace')
	@section('keywords', str_replace(' ', ', ', $scripts->first()->game->title))
...
@section('page', 'page-games-scripts')		
@section('content')
<!-- START @PAGE CONTENT -->
				...
				<div class="panel-heading">
					<form class="form-horizontal" method="GET" style="padding-top: 8px!important;">
						<div class="form-group no-margin no-padding has-feedback">
							...
							<div class="col-md-2">
								<div class="input-group" style="width: 100%;">
								<span class="input-group-addon bg-theme">Sort by</span>
							...
							<div class="col-md-2">
								<div class="input-group" style="width: 100%;">
								<span class="input-group-addon bg-theme">Added</span>
