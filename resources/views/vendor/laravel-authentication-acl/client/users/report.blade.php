...
@section('page', 'page-users-report') 
@section('content')
<!-- START @PAGE CONTENT -->
			...
			<div class="col-lg-9 col-md-9 col-sm-8 col-xs-12">
				...
				<div class="panel panel-tab rounded shadow">
					...
					<div class="panel-heading">
						<h3 class="panel-title">{{ trans('front/users/view.report') }} <code>{{ $user->user_profile->first()->first_name}}</code></h3>
					</div>
					<!-- Start tabs content -->
							...
							<div class="tab-pane fade in active" id="tab1">
								<div class="panel-body no-padding">
									<div class="panel-body">
										...
										<div class="form-body">
											{!! Form::model($user, [ 'url' => URL::route('report.users', ['id' => $user->id]), 'class' => 'form-horizontal mt-10'] )  !!}
											<div class="form-group">
												{!! Form::textarea('text', null, ['class' => 'textarea form-control', 'autocomplete' => 'off']) !!}
											</div>
											<div class="form-footer">
												<div class="pull-right">
												{!! Form::submit(trans('front/users/view.form-button-report'), array("class"=>"btn btn-danger")) !!}
												</div>
											</div>
											{!! Form::close() !!}
										</div>
