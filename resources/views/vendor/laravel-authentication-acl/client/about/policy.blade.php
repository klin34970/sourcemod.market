...
@section('keywords', 'privacy, policy, rule')
			...
			<div class="col-md-12">
				<div class="panel panel-invoice rounded">
					<div class="panel-body">
						...
						<h2>Sourcemod Market Privacy Policy</h2>
						<div id='ppBody'>
							...
							<br />
							<div class='innerText'>When ordering or registering on our site, as appropriate, you may be asked to enter your name, email address, mailing address, paypal or other details to help you with your experience.</div>
							<br>
							...
							<br>
							<div class='innerText'>We, along with third-party vendors such as Google use first-party cookies (such as the Google Analytics cookies) and third-party cookies (such as the DoubleClick cookie) or other third-party identifiers together
								<div class='innerText'>for stats</div>
								<div class='innerText'>
									<br><strong>Opting out:</strong>
									<br> Users can set preferences for how Google advertises to you using the Google Ad Settings page. Alternatively, you can opt out by visiting the Network Advertising Initiative Opt Out page or by using the Google Analytics Opt Out Browser add on.</div><span id='calOppa'></span>
								<br>
								...
								<div class='innerText'><strong><br>If at any time you would like to unsubscribe from receiving future emails, you can email us at</strong></div>contact@sourcemod.market and we will promptly remove you from <strong>ALL</strong> correspondence.</div>
							...
							<div class='innerText'>sourcemod.market</div>
							<div class='innerText'>39 rue substantion</div>Palavas les flots, Hérault 34250
							<div class='innerText'>France</div>
							<div class='innerText'>contact@sourcemod.market</div>
							<div class='innerText'>
								<br>Last Edited on 2016-08-13</div>
						</div>
