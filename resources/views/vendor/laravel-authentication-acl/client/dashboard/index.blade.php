			...
			<div class="col-md-12">
				...
				<div class="panel rounded shadow panel-default">
					...
					<div class="panel-body">
						...
						<div class="col-md-4 col-sm-4 col-xs-12  col-xs-override">
							<div class="mini-stat no-padding no-margin">
								<div class="mini-stat-info text-right">
									<span>
									@if($logged_user->hasPermission(['_vip']))
										0%
									@else
										{{$logged_user->user_profile()->first()->rank_sale->comission}}%
									@endif
									</span>
									<p class="text-muted no-margin">{{ trans('front/dashboard/view.commission') }}</p>
								</div><!-- /.mini-stat-info -->
							</div><!-- /.mini-stat -->
						</div>
