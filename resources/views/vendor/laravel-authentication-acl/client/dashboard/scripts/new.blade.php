				...
				<div id="script-edit">
					<div class="panel panel-tab panel-tab-double panel-tab-vertical row no-margin rounded shadow">
						...
						<div class="panel-body col-md-9">
							{!! Form::model(null, [ 'url' => URL::route('dashboard.scripts.new'), 'files'=>true, 'class' => 'tab-content form-horizontal'] )  !!}
								...
								<div class="tab-pane fade inner-all" id="tab4">
									...
									<div class="form-group">
										{!! Form::label('changes',trans('front/dashboard/scripts/versions/edit.form-file'), ['class' => 'col-sm-2']) !!}
										<div class="col-md-10">
