				...
				<div id="script-version-edit">
					<div class="panel rounded shadow">
						...
						<div class="panel-body no-padding">
							{!! Form::model($version, [ 'url' => URL::route('dashboard.scripts.versions.edit', ['script_id' => $version->script_id, 'version_id' => $version->id]), 'files'=>true, 'class' => 'form-horizontal mt-10'] )  !!}
								<div class="form-body">
