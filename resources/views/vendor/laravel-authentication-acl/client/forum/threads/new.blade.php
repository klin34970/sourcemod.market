			...
			<div class="col-md-12">
				...
				<div class="panel rounded shadow">
					<div class="panel-heading">
						<div class="pull-left">
							<h3 class="panel-title">{{ trans('front/forum/threads.thread-to') }}: {{ $forum->title }}</h3>
						</div>
						<div class="clearfix"></div>
					</div><!-- /.panel-heading -->
					<div class="panel-body no-padding">

						{!! Form::model(null, [ 'url' => URL::route('community.forum.threads.new', ['id' => $forum->id, 'title' => App\Http\Classes\Slug::filter($forum->title)]), 'class' => 'form-horizontal'] )  !!}
							<div class="form-body">
							...
							<div class="form-footer">
								<button type="submit" class="btn btn-success">{{ trans('front/forum/threads.button-save-new') }}</button>
							</div><!-- /.form-footer -->
						{!! Form::close() !!}
