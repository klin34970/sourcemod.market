			...
			<div class="col-md-12">
				...
				<div class="panel rounded shadow">
					<div class="panel-heading">
						<div class="pull-left">
							<h3 class="panel-title">{{ trans('front/forum/threads.thread-edit') }}: {{ $thread->title }}</h3>
						</div>
						<div class="clearfix"></div>
					</div><!-- /.panel-heading -->
					<div class="panel-body no-padding">

						{!! Form::model(null, [ 'url' => URL::route('community.forum.threads.edit', ['id' => $thread->id, 'title' => App\Http\Classes\Slug::filter($thread->title)]), 'class' => 'form-horizontal'] )  !!}
							<div class="form-body">
								<div class="form-group">
									{!! Form::text('title', $thread->title, ['class' => 'form-control', 'autocomplete' => 'off']) !!}
								</div><!-- /.form-group -->
								<div class="form-group">
									{!! Form::textarea('text', $thread->text, ['class' => 'textarea form-control', 'autocomplete' => 'off']) !!}
								</div><!-- /.form-group -->
							</div><!-- /.form-body -->
