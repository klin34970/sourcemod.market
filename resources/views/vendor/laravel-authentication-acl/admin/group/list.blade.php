...
@section('title', trans('admin/groups/list.title'))
@section('page', 'page-groups-list') 
...
<section id="page-content">
	...
	<div class="header-content">
		<h2><i class="fa fa-users"></i> {{ trans('admin/groups/list.header-title') }} <span>{{ trans('admin/groups/list.header-title-small') }}</span></h2>
		<div class="breadcrumb-wrapper hidden-xs">
			<span class="label">{{ trans('admin/groups/list.header-you-are-here') }}:</span>
			<ol class="breadcrumb">
				<li>
					<i class="fa fa-angle-right"></i>
					<a href="{!! URL::route('dashboard.default') !!}">{{ trans('admin/groups/list.breadcrumb-home') }}</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<a href="#">{{ trans('admin/groups/list.breadcrumb-groups') }}</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li class="active">{{ trans('admin/groups/list.breadcrumb-active') }}</li>
			</ol>
				...
				<div class="panel rounded shadow">
					<div class="panel-body">
						...
						<table id="datatable-dom" class="table table-striped table-theme">
								<thead>
								<tr>
									<th data-class="expand">{{ trans('admin/groups/list.table-header-name') }}</th>
									<th data-hide="phone, tablet" class="text-center" style="width: 200px;">{{ trans('admin/groups/list.table-header-action') }}</th>
								</tr>
								</thead>
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										@if(! $group->protected)
										<a href="{!! URL::route('groups.edit', ['id' => $group->id]) !!}" class="btn btn-primary btn-xs btn-push" data-toggle="tooltip" data-placement="top" data-original-title="{{ trans('admin/groups/list.table-edit-tooltip') }}"><i class="fa fa-pencil"></i> {{ trans('admin/groups/list.table-edit') }}</a>
										<a href="{!! URL::route('groups.delete',['id' => $group->id, '_token' => csrf_token()]) !!}" class="btn btn-danger btn-xs delete btn-push" data-toggle="tooltip" data-placement="top" data-original-title="{{ trans('admin/groups/list.table-delete-tooltip') }}"><i class="fa fa-times"></i> {{ trans('admin/groups/list.table-delete') }}</a>
										@endif
									</td>
								</tr>
								@endforeach
...
@section('scripts')	
	...
	{!! Html::script('assets/admin/js/pages/blankon.groups.list.js') !!}
	{!! Html::script('assets/admin/js/demo.js') !!}
    <script>
        $(".delete").click(function(){
            return confirm('{!! trans("admin/groups/list.confirm-delete") !!}');
        });
		BlankonTable.init(
