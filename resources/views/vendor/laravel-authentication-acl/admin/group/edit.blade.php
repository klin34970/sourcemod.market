...
@if(isset($user->id))
	@section('title', trans('admin/groups/edit.title-edit')) 
@else
	@section('title', trans('admin/groups/edit.title-add')) 
@endif

@section('page', 'page-groups-edit') 
...
<section id="page-content">
	...
	<div class="header-content">
		<h2>
		{!! isset($group->id) ? trans('admin/groups/edit.header-title-edit') : trans('admin/groups/edit.header-title-add') !!}
		</h2>
		<div class="breadcrumb-wrapper hidden-xs">
			<span class="label">{{ trans('admin/groups/edit.header-you-are-here') }}:</span>
			<ol class="breadcrumb">
				<li>
					<i class="fa fa-home"></i>
					<a href="{!! URL::route('dashboard.default') !!}">{{ trans('admin/groups/edit.breadcrumb-home') }}</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li>
					<a href="#">{{ trans('admin/groups/edit.breadcrumb-group') }}</a>
					<i class="fa fa-angle-right"></i>
				</li>
				<li class="active">{!! isset($group->id) ? trans('admin/groups/edit.breadcrumb-active-edit') : trans('admin/groups/edit.breadcrumb-active-add') !!}</li>
			</ol>
                ...
                <div class="body-content animated fadeIn">
                    ...
                    <div class="row">
						<div class="col-md-6 col-xs-12">
							<div class="panel panel-theme">
								<div class="panel-heading">
									<h3 class="panel-title">{{ trans('admin/groups/edit.panel-title-1') }}</h3>
								</div><!-- /.panel-heading -->
								<div class="panel-body">
									...
									<div class="form-group">
										{!! Form::label('name', trans('admin/groups/edit.form-label-name')) !!}
										{!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => trans('admin/groups/edit.form-placeholder-name')]) !!}
									</div>
									<span class="text-danger">{!! $errors->first('name') !!}</span>
									{!! Form::hidden('id') !!}
									<a href="{!! URL::route('groups.delete',['id' => $group->id, '_token' => csrf_token()]) !!}" class="btn btn-danger pull-right margin-left-5 delete">{{ trans('admin/groups/edit.form-button-delete') }}</a> 
									{!! Form::submit(trans('admin/groups/edit.form-button-save'), array("class"=>"btn btn-info pull-right ")) !!}
									{!! Form::close() !!}
								</div><!-- /.panel-body -->
							</div>
						</div>
						<div class="col-md-6 col-xs-12">
							<div class="panel panel-theme">
                                <div class="panel-heading">
                                    <h3 class="panel-title">{{ trans('admin/groups/edit.panel-title-2') }}</h3>
                                </div><!-- /.panel-heading -->
                                <div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="form-group">
											@if(! $group->exists)
											<span class="text-danger"><h5>{{ trans('admin/groups/edit.form-create-group-first') }}</h5></span>
											@endif
										</div>
									{!! Form::close() !!}
									...
									@endforeach
									@elseif($group->exists)
									<span class="text-warning"><h5>{{ trans('admin/groups/edit.form-no-group') }}</h5></span>
									@endif
                                </div><!-- /.panel-body -->
                            </div>
						</div>
...
@section('scripts')	
    ...
    <script>
        $(".delete").click(function(){
            return confirm('{!! trans("admin/groups/edit.confirm-delete") !!}');
        });
    </script>
	<script>
