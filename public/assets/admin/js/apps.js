...
var BlankonApp = function(){
    ...
    return {
        ...
        init: function () {
			...
			BlankonApp.handleQuote();
			
			//console.log(BlankonApp.handleBaseURL()+'/assets/typeahead/typeahead.json');
        },
        ...
        handleSidebarResponsive: function () {
            ...
            $('.navbar-minimize a').on('click',function(){
                ...
                if ($.cookie('page_sidebar_minimize') == "undefined" || $.cookie('page_sidebar_minimize') == "not_active") {
                    ...
                    $.cookie('page_sidebar_minimize','active', {expires: 1, path: '/'});
                }
                ...
                // If the cookie was already set to active then remove it
                    ...
                    $.cookie('page_sidebar_minimize','not_active',  {expires: 1, path: '/'});
        ...
        handleTypehead: function () {
            if($('.typeahead').length){
                ...
                var scripts = new Bloodhound({
                    ...
                    prefetch: BlankonApp.handleBaseURL()+'/assets/typeahead/typeahead.json',
					cache: false
                });

				scripts.clearPrefetchCache();
                scripts.initialize();
                ...
                $('.typeahead').typeahead(null, {
                    ...
                    templates: {
                        ...
                        suggestion: Handlebars.compile([
                            '<a href="{{url}}" class="media border-dotted animated fadeIn">',
        ...
        handleQuote : function () 
		{
			$('._quote').click(function(e) 
			{
				...
				var quoteText = "<div class='quote-reply'><b>" + authorName + " said:</b><br>" + quoteBody + "</div><br><br>";

				$('.textarea').data("wysihtml5").editor.setValue(quoteText);
